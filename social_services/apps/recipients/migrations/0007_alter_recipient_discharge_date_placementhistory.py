...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('recipients', '0006_remove_recipient_status_statushistory'),
    ...
    operations = [
        migrations.AlterField(
            ...
            name='discharge_date',
            field=models.DateField(blank=True, null=True, verbose_name='Дата смены статуса'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='placement_arrivals', to='core.department', verbose_name='Новое отделение')),
                ('old_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='placement_departures', to='core.department', verbose_name='Предыдущее отделение')),
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='placement_history', to='recipients.recipient', verbose_name='Получатель услуг')),
            ],
            options={
