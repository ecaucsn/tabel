...
urlpatterns = [
    ...
    path('edit/<int:service_id>/', views.service_edit_view, name='service_edit'),
    path('bulk-edit/', views.service_bulk_edit_view, name='bulk_edit'),
    path('assign-tabel/', views.service_recipients_tabel_view, name='assign_tabel'),
    ...
    path('api/category-services/', views.get_category_services_api, name='get_category_services_api'),
